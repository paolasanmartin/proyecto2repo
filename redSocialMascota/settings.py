"""
Django settings for redSocialMascota project.
...
SECRET_KEY = 'vg+&5-@#y^a=btf=qp2mce8fzg*d-lcp9&t#mu&047%_fsjpme'
...
ROOT_URLCONF = 'redSocialMascota.urls'
...
WSGI_APPLICATION = 'redSocialMascota.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'db', # nombre de la base de datos, se creará en el servidor de Postgres a continuación
